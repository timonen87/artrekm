...
const SingleBrand = ({ brand }: { brand: Brand }) => {
  ...
  return (
    <div className="flex  items-center justify-center px-3 py-[15px] sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">
      <a
        href={href}
        target="_blank"
      ...
      >
        ...
        <Image src={image} alt={name} className="block dark:hidden" width={140} height={100}/>
      </a>
    </div>
  );
};
