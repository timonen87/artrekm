    ...
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
          ...
          <div className="py-8">
            <p className=" flex items-center justify-between  text-center text-base text-body-color dark:text-white">
              <div><Link
                    href="https://te.me"
                    className="hidden  text-base font-medium text-dark hover:opacity-70 dark:text-white md:block"
                    target="true"
                  >
                    <svg
                      width="30"
